...
{
    if(p->leftChild == NULL) printf("Node %d dose not has LeftChild", p->id);
    else printf(", LeftChild = %d", p->leftChild->id);
    if(p->rightChild == NULL) printf("Node %d dose not has RightChild", p->id);
